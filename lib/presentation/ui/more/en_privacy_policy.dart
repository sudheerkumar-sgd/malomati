...
class EnPrivacyPolicy extends StatelessWidget {
  const EnPrivacyPolicy({super.key});
        ...
        children: <TextSpan>[
          ...
          TextSpan(
              ...
              style: context.textFontWeight400
                  .onFontSize(context.resources.fontSize.dp12)),
          TextSpan(
              text: '\u2022 Provide you content based upon your location;\n',
              style: context.textFontWeight400
                  .onFontSize(context.resources.fontSize.dp12)),
          TextSpan(
              text: '\u2022 Provide your local search results;\n',
              style: context.textFontWeight400
                  .onFontSize(context.resources.fontSize.dp12)),
          TextSpan(
              text:
          ...
          TextSpan(
              ...
              style: context.textFontWeight700
                  .onFontSize(context.resources.fontSize.dp15)),
          TextSpan(
              text: 'We also collect the following information from you:\n\n',
              style: context.textFontWeight700
                  .onFontSize(context.resources.fontSize.dp12)),
          TextSpan(
              text:
          ...
          TextSpan(
              ...
              style: context.textFontWeight400
                  .onFontSize(context.resources.fontSize.dp12)),
          TextSpan(
              text: '\u2022 Send you a request confirmation;\n',
              style: context.textFontWeight400
                  .onFontSize(context.resources.fontSize.dp12)),
          TextSpan(
              text:
          ...
          TextSpan(
              ...
              style: context.textFontWeight400
                  .onFontSize(context.resources.fontSize.dp12)),
          TextSpan(
              text: '\u2022 Send product updates or warranty information;\n',
              style: context.textFontWeight400
                  .onFontSize(context.resources.fontSize.dp12)),
          TextSpan(
          ...
          TextSpan(
              ...
              style: context.textFontWeight400
                  .onFontSize(context.resources.fontSize.dp12)),
          TextSpan(
              text: '\u2022 Send you marketing communications;\n',
              style: context.textFontWeight400
                  .onFontSize(context.resources.fontSize.dp12)),
          TextSpan(
              text: '\u2022 Improve our Malomati and marketing efforts;\n',
              style: context.textFontWeight400
                  .onFontSize(context.resources.fontSize.dp12)),
          TextSpan(
              text: '\u2022 Conduct research and analysis;\n',
              style: context.textFontWeight400
                  .onFontSize(context.resources.fontSize.dp12)),
          TextSpan(
              text: '\u2022 Respond to your questions and concerns; and\n',
              style: context.textFontWeight400
                  .onFontSize(context.resources.fontSize.dp12)),
          TextSpan(
              text: '\u2022 Display content based upon your interests.\n\n',
              style: context.textFontWeight400
                  .onFontSize(context.resources.fontSize.dp12)),
          TextSpan(
              text: 'Cookies\n\n',
