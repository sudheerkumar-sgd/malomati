...
const String attendanceUserDetailsApiUrl =
    'user?action=get;format=json;field-name=location-mandatory';
const String attendanceUserPunchDetailsApiUrl =
    'user?action=get;format=json;field-name=id,name,punch-api,active-directory-username;';
...
const String deleteLeaveApiUrl =
    'UAQSGD_MOB_ERP_RequestToDeleteLeaves/DeleteLeaves/Delete';
...
const String deleteleavesApiUrl =
    'UAQSGD_MOB_ERP_RequestToDeleteLeaves/DeleteLeaves/Leaves';
